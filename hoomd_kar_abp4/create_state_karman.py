...
rx=np.loadtxt("../data_file/rx_{0}_{1}.txt".format(rho,static_dia))
ry=np.loadtxt("../data_file/ry_{0}_{1}.txt".format(rho,static_dia))
...
ljw.params['Move'] = {"epsilon": 1.0, "sigma": 1.0, "r_cut": sigma_ab*2**(1/6)-static_dia/2}
