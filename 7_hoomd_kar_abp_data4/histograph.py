...
rho=0.8 
ave_flow_list=[3.0,5.0, 10.0]
static_dia=40.0
acive_force_list=[6.0, 2.0 ,0.0]
D=0.1
...
for dir in files_dir:
    ...
    plt.hist(data,bins=100,color="orange",density=True)
    plt.ylim(0.0 ,18)
    plt.xlim(0.0,1.0)
    ...
    # plt.title(r'$U={0}$'.format(U))
    # plt.ylabel(r"$f(\|\phi_6\|)$",fontsize=15)
    plt.xlabel(r'$\|\phi_6\|$',fontsize=15)
    # sns.kdeplot(data=data)
    output_path="./phi6_hist_{0}_{1}.png".format(U,v0)
