...
input_traj = gsd.hoomd.open('../hoomd_kar_abp5/{0}/log_pos_{0}.gsd'.format(ver), 'rb')

print(len(input_traj))
input_pos=input_traj[-1].particles.position.T
rx=input_pos[0]
ry=input_pos[1]


input_vel=input_traj[-1].particles.velocity
...
# 速度受け継ぎ
snapshot.particles.velocity=input_vel
