...
rho_list=(0.8)
ave_flow_list=(  5.0 10.0 )
static_dia=50.0
reduced_speed_list=(0.001 1.0  )
rotational_diffusion_list=(1.0)
for rho in "${rho_list[@]}"
do 
    ...
    do
        ...
        do
            ...
            do
                ...
                nohup time python create_state_karman_t.py $rho $ave_flow $static_dia $reduced_speed  $rotational_diffusion > ${name}.log 2>&1 &
